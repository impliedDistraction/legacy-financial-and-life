export const site = {
  ...
  // Scheduling configuration — using Calendly temporarily
  scheduling: {
    // Calendly URL for Tim and Beth
    calendlyUrl: 'https://calendly.com/bethandtim-legacy',
    // Brand color for embed (falls back to brand blue if missing)
    brandColor: '#1a62db',
  },
